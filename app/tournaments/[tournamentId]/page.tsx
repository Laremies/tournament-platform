    ...
    return (
        <div className="container mx-auto p-4 space-y-6" >
            <div className="text-center space-y-2">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">{tournament?.description}</p>
            </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center">
                                ...
                                <span>Tournament Status: {tournament?.finished ? "tournament ended" : tournament?.started ? "Ongoing" : "Waiting for players"}</span>
                            </div>
                            <div className="flex items-center">
                                <Users className="mr-2 h-4 w-4 text-primary" />
                                <span>Max player amount: {tournament?.max_player_count || "Unlimited"}</span>
                            </div>
                            <div className="flex items-center">
                        ...
                        <CardContent>
                            <ScrollArea className="h-[200px] pr-4">
                                <div className="space-y-4">
                                    {tournamentPlayers && tournamentPlayers.map((participant) => (
